...
public class ShadeExert extends AbstractDynamicCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with ShadeExert
    ...
    public static final String ID = TheShadeMod.makeID(ShadeExert.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("ShadeExert.png");
