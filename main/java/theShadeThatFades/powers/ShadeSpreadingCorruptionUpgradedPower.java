...
public class ShadeSpreadingCorruptionUpgradedPower extends AbstractPower {
    public static final String POWER_ID = "theShadeThatFades:SpreadingCorruptionUpgradedPower";
    ...
    public ShadeSpreadingCorruptionUpgradedPower(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
