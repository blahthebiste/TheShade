...
import theShadeThatFades.powers.ShadeEidolonFormPower;

import static theShadeThatFades.TheShadeMod.makeCardPath;

public class ShadeEidolonForm extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = TheShadeMod.makeID(ShadeEidolonForm.class.getSimpleName());
    ...
    public void use(final AbstractPlayer p, final AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new ShadeEidolonFormPower(p)));
    }
