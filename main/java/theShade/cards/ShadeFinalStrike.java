...
public class ShadeFinalStrike extends AbstractDynamicCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with ShadeFinalStrike
    ...
    public static final String ID = DefaultMod.makeID(ShadeFinalStrike.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
