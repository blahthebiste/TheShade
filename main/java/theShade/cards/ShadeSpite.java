...
public class ShadeSpite extends AbstractDynamicCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with ShadeSpite
     * And then you can do custom ones like 10 and  if you want.
    ...
    public static final String ID = DefaultMod.makeID(ShadeSpite.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
