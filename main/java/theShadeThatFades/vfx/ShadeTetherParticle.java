...
public class ShadeTetherParticle extends AbstractGameEffect {
    ...
    public ShadeTetherParticle(float sX, float sY, float tX, float tY, boolean facingLeft) {
        ...
        this.rotationRate = MathUtils.random(8000.0F, 9500.0F) * Settings.scale;
        this.currentSpeed = 100.0F * Settings.scale;
        this.color = new Color(1.0F, 0.0F, 0.02F, 0.3F); // Hot red
        this.backgroundColor = new Color(0.0F, 0.0F, 0.0F, 0.20F); // Dim black
        this.duration = 1.7F;
        this.scale = 0.50F * Settings.scale;
...
//            this.isDone = true;
            this.duration = 0.0165f;
//            this.color = new Color(0.20F, 0.10F, 1.0F, 0.3F); // Debug blue
        }
