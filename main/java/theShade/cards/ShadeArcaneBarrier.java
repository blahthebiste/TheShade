...
public class ShadeArcaneBarrier extends AbstractDynamicCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with ShadeArcaneBarrier
    ...
    public static final String ID = DefaultMod.makeID(ShadeArcaneBarrier.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
