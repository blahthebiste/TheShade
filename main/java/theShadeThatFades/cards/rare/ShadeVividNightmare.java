...
public class ShadeVividNightmare extends AbstractDynamicCard {
    ...
    public static final String ID = TheShadeMod.makeID(ShadeVividNightmare.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(m, p, new RegenPower(m, magicNumber), magicNumber));
    }
