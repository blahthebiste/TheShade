...
import theShade.powers.ShadeSpreadingCorruptionPower;
import theShade.powers.ShadeVesselOfSufferingPower;

import static theShade.DefaultMod.makeCardPath;

public class ShadeSpreadingCorruption extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(ShadeSpreadingCorruption.class.getSimpleName());
    public static final String IMG = makeCardPath("ShadeSpreadingCorruption.png");
