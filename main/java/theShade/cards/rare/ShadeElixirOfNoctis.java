...
import theShade.powers.ShadeElixirOfNoctisPower;
...
public class ShadeElixirOfNoctis extends AbstractDynamicCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with ShadeElixirOfNoctis
    ...
    public static final String ID = DefaultMod.makeID(ShadeElixirOfNoctis.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
