...
import theShadeThatFades.monsters.ShadeDoll;
...
public class ShadeVoodooDoll extends AbstractDynamicCard {
    ...
    public static final String ID = TheShadeMod.makeID(ShadeVoodooDoll.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
