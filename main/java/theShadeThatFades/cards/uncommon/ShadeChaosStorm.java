...
import theShadeThatFades.powers.ShadeChaosStormPower;
import theShadeThatFades.powers.ShadeChaosStormUpgradedPower;
...
public class ShadeChaosStorm extends AbstractDynamicCard {
    ...
    public static final String ID = TheShadeMod.makeID(ShadeChaosStorm.class.getSimpleName());
