...
import theShadeThatFades.powers.ShadeCorruptionNextTurnPower;
...
public class ShadeShadowBarrier extends AbstractDynamicCard {
    ...
    public static final String ID = TheShadeMod.makeID(ShadeShadowBarrier.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
