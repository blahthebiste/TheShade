...
import theShade.powers.ShadeSubversionPower;
...
public class ShadeSubversion extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(ShadeSubversion.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
