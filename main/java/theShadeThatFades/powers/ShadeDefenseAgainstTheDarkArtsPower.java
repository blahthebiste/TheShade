...
public class ShadeDefenseAgainstTheDarkArtsPower extends AbstractPower {
    public static final String POWER_ID = "theShadeThatFades:ShadeDefenseAgainstTheDarkArtsPower";
    ...
    public ShadeDefenseAgainstTheDarkArtsPower(AbstractCreature owner, int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
