...
public class ShadeVividNightmare extends AbstractDynamicCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with ShadeVividNightmare
     * And then you can do custom ones like 27 and  if you want.
    ...
    public static final String ID = DefaultMod.makeID(ShadeVividNightmare.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("ShadeVividNightmare.png");
    ...
    public ShadeVividNightmare() { // - This one and the one right under the imports are the most important ones, don't forget them
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(m, p, new RegenerateMonsterPower(m, magicNumber), magicNumber));
    }
