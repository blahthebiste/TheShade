...
public class ShadeWitherPower extends AbstractPower {
    public static final String POWER_ID = "theShade:Wither";
    ...
    public void stackPower(int stackAmount) {
        ...
        if (this.amount <= 0) {
            this.addToTop(new RemoveSpecificPowerAction(this.owner, this.owner, "theShade:Wither"));
        }
...
//        if (this.amount == 0) {
//            this.addToBot(new RemoveSpecificPowerAction(this.owner, this.owner, "theShade:Wither"));
//        } else {
            this.addToBot(new ReducePowerAction(this.owner, this.owner, "theShade:Wither", 1));
//        }
    }
