...
public class ShadeDusk extends AbstractDynamicCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with Dusk
    ...
    public static final String ID = TheShadeMod.makeID(ShadeDusk.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("ShadeDusk.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractCard c = (new ShadeShadows()).makeCopy(); // Create new strikes to shuffle into draw pile.
        if(upgraded) {
            c.upgrade();
        }
