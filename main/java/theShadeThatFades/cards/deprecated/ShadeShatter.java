...
import theShadeThatFades.powers.ShadeShatterPower;
import theShadeThatFades.powers.ShadeShatterUpgradedPower;
...
public class ShadeShatter extends AbstractDynamicCard {
    ...
    public static final String ID = TheShadeMod.makeID(ShadeShatter.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
