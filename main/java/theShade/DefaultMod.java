...
//    public static final Color PLACEHOLDER_POTION_SPOTS = CardHelper.getColor(100.0f, 25.0f, 10.0f); // Super Dark Red/Brown
    ...
    private static final String ATTACK_DEFAULT_GRAY = "theShadeResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "theShadeResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "theShadeResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "theShadeResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "theShadeResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "theShadeResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "theShadeResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "theShadeResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "theShadeResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "theShadeResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "theShadeResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "theShadeResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "theShadeResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "theShadeResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "theShadeResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "theShadeResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "theShadeResources/images/char/defaultCharacter/skeleton.json";
...
//        BaseMod.addCard(new DefaultRarePower());
        ...
        BaseMod.addCard(new ShadeFatigue());
        BaseMod.addCard(new ShadeTorture());
        BaseMod.addCard(new ShadeDefile());
        ...
        BaseMod.addCard(new ShadePossession());
        BaseMod.addCard(new ShadeDelve());
        BaseMod.addCard(new ShadeDarkTendrils());
...
//        BaseMod.addCard(new ShadeShatter()); //DEPRECATED
        ...
        BaseMod.addCard(new ShadeShadeDance());
        ...
        BaseMod.addCard(new ShadeOblivion());
        BaseMod.addCard(new ShadeMutualAnnihilation());
        BaseMod.addCard(new ShadeArcaneTempest());
...
//        UnlockTracker.unlockCard(DefaultRarePower.ID);
        ...
        UnlockTracker.unlockCard(ShadeFatigue.ID);
        UnlockTracker.unlockCard(ShadeTorture.ID);
        UnlockTracker.unlockCard(ShadeSpite.ID);
        UnlockTracker.unlockCard(ShadeDefile.ID);
        UnlockTracker.unlockCard(ShadeContaminate.ID);
        UnlockTracker.unlockCard(ShadeCorruptBlade.ID);
        UnlockTracker.unlockCard(ShadeFinalStrike.ID);
        UnlockTracker.unlockCard(ShadeArcaneLightning.ID);
        UnlockTracker.unlockCard(ShadeStrangle.ID);
        UnlockTracker.unlockCard(ShadeShadowStrike.ID);
        ...
        UnlockTracker.unlockCard(ShadeForbiddenThoughts.ID);
        UnlockTracker.unlockCard(ShadeDusk.ID);
        UnlockTracker.unlockCard(ShadeArcaneBarrier.ID);
        UnlockTracker.unlockCard(ShadeEncroachingShadows.ID);
        UnlockTracker.unlockCard(ShadeVesselOfSuffering.ID);
        // Uncommon
        UnlockTracker.unlockCard(ShadeTorment.ID);
        UnlockTracker.unlockCard(ShadeSchadenfreude.ID);
        UnlockTracker.unlockCard(ShadePossession.ID);
        UnlockTracker.unlockCard(ShadeDelve.ID);
        UnlockTracker.unlockCard(ShadeDarkTendrils.ID);
        UnlockTracker.unlockCard(ShadeBlackLightning.ID);
        UnlockTracker.unlockCard(ShadeScourge.ID);
        UnlockTracker.unlockCard(ShadeFalteringBlade.ID);
        UnlockTracker.unlockCard(ShadeRebuff.ID);
        UnlockTracker.unlockCard(ShadeWitchFire.ID);
        UnlockTracker.unlockCard(ShadeWrithingFlame.ID);
        UnlockTracker.unlockCard(ShadeTarnish.ID);
        UnlockTracker.unlockCard(ShadeAnoint.ID);
        UnlockTracker.unlockCard(ShadeHaunt.ID);
        UnlockTracker.unlockCard(ShadeDeception.ID);
        UnlockTracker.unlockCard(ShadeBlackHeart.ID);
//        UnlockTracker.unlockCard(ShadeShatter.ID); //DEPRECATED
        UnlockTracker.unlockCard(ShadeForbiddenKnowledge.ID);
        UnlockTracker.unlockCard(ShadeRemission.ID);
        UnlockTracker.unlockCard(ShadeShadeDance.ID);
        ...
        UnlockTracker.unlockCard(ShadeOblivion.ID);
        UnlockTracker.unlockCard(ShadeMutualAnnihilation.ID);
        UnlockTracker.unlockCard(ShadeArcaneTempest.ID);
