...
import theShadeThatFades.actions.ShadeInfusionTickAction;
import theShadeThatFades.util.TextureLoader;

import static theShadeThatFades.TheShadeMod.makePowerPath;

public class ShadeInfusionPower extends AbstractPower {
    public static final String POWER_ID = "theShadeThatFades:ShadeInfusionPower";
    ...
    public ShadeInfusionPower(AbstractCreature owner, int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
...
//        System.out.println("end of round");
        this.addToBot(new ShadeInfusionTickAction(this.owner, false));
    }
