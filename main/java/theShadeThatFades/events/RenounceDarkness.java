package theShadeThatFades.events;
...
import theShadeThatFades.cards.ShadePurge;
import theShadeThatFades.cards.ShadeShadows;

import java.util.ArrayList;

import static theShadeThatFades.TheShadeMod.makeEventPath;

public class RenounceDarkness extends AbstractImageEvent {


    public static final String ID = TheShadeMod.makeID("RenounceDarkness");
            ...
            case 0: // While you are on screen number 0 (The starting screen)
                switch (i) {
                    case 0: // If you press button the first button (Button at index 0): Renounce Darkness
                        imageEventText.loadImage("theShadeThatFadesResources/images/events/RenounceDarkness2.png"); // Change the shown image
