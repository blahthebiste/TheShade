...
public class ShadeUnveil extends AbstractDynamicCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with ShadeUnveil
    ...
    public static final String ID = DefaultMod.makeID(ShadeUnveil.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
